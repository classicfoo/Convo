...
<div class="space-y-8">
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white">
        <div class="border-b border-slate-200 bg-white px-6 py-6">
            ...
            <p class="mt-3 text-sm text-slate-600">A light, neutral dashboard designed for calm productivity.</p>
        </div>
        <div class="grid gap-6 px-6 py-6 md:grid-cols-3">
            <div class="rounded-xl border border-slate-200 bg-white p-4">
                ...
                <p class="mt-2 text-sm text-slate-600">You’re securely authenticated.</p>
            </div>
            <div class="rounded-xl border border-slate-200 bg-white p-4">
                ...
                <div class="mt-2 flex items-center justify-between">
                    ...
                    <span class="rounded-full border border-slate-900 bg-white px-3 py-1 text-xs font-semibold text-slate-900"><?= htmlspecialchars($user['username']) ?></span>
                </div>
                <p class="mt-2 text-sm text-slate-600">Navigate using the header to manage your workspace.</p>
            </div>
            <div class="rounded-xl border border-slate-200 bg-white p-4">
