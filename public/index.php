...
<div class="space-y-8">
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white">
        <div class="border-b border-slate-200 bg-slate-50 px-6 py-6">
            <p class="text-xs font-semibold uppercase tracking-[0.08em] text-slate-500">Welcome back</p>
            ...
            <p class="mt-3 text-sm text-slate-600">A light, neutral dashboard that keeps focus on your work.</p>
        </div>
