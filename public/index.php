...
<div class="space-y-8">
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-subtle">
        <div class="border-b border-slate-200 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 px-6 py-6 text-white">
            <p class="text-sm uppercase tracking-[0.08em] text-slate-300">Welcome back</p>
            <h1 class="mt-2 text-3xl font-semibold leading-snug">Hi <?= htmlspecialchars($user['display_name']) ?>, here’s your Convo workspace</h1>
            <p class="mt-3 text-sm text-slate-300">A calm, neutral dashboard inspired by the simplicity of ChatGPT and GitHub.</p>
        </div>
